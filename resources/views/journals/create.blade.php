...
<div class="create-entry-page">
    <form action="{{ route('journals/store') }}" method="POST" class="create-entry-card">
        ...
        <textarea name="content" id="journal-content" class="form-control content-input" placeholder="Start writing your thoughts, memories, or reflections here..." required></textarea>
